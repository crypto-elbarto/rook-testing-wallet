...
stablecol_1, stablecol_2, stablecol_3, stablecol_4 = st.columns(spec=4, gap="medium")
...
with stablecol_3:
    ...
    # st.table(token_sent[token_sent['symbol_x']=='USDT'][['timestamp_x','path', 'token_amount_x']].sort_values('timestamp_x', ascending=False))
    # with st.expander("Recent Trades"):
    # st.write("# Trades")
with stablecol_4:
    st.subheader("FRAX")
    ...
    # st.table(token_sent[token_sent['symbol_x']=='FRAX'][['timestamp_x','path', 'token_amount_x']].sort_values('timestamp_x', ascending=False))
    # with st.expander("Recent Trades"):
    # st.write("# Trades")
